    ...
    if ($password === $confirm_password) {
        ...
        if ($result->num_rows == 0) {
            ...
            if (mysqli_query($mysqli, $insert_query)) {
                ...
                document.location='index.php?page=admlogin';
                </script>";
            } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=admregister">
                        <?php
                        if (isset($error)) {
                    ...
                    <div class="text-center">
                        <p class="mt-3">Sudah Punya Akun? <a href="index.php?page=admlogin">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
