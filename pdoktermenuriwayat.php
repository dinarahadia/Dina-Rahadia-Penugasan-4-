...
<head>
    ...
    <title>Menu Riwayat Periksa Dokter</title>
            ...
            <div class="sidebar">
              ...
              with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            <a href="pdoktermenu.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="pdoktermenuriwayat.php" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    if (isset($_GET['page'])) {
                        // Check if the requested page is login, and if so, include doklogin.php
                        if ($_GET['page'] === 'doklogin') {
                            include("doklogin.php");
                        } elseif ($_GET['page'] === 'pdokterriwayat') {
                            // Include riwayatdokperiksa.php for the 'riwayatperiksa' page
                            include("pdokterriwayat.php");
                        } else {
