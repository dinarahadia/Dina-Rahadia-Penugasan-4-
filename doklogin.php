...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            $_SESSION['nama'] = $nama;
            header("Location: pdoktermenu.php");
        } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=doklogin">
                        <?php
                        if (isset($error)) {
                    ...
                    <div class="text-center">
                        <p class="mt-3">Belum punya akun? <a href="index.php?page=dokregister">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
