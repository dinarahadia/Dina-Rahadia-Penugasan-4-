    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Dashboard Obat Admin</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          if (isset($_GET['page'])) {
            // Check if the requested page is login, and if so, include admlogin.php
            if ($_GET['page'] === 'login') {
              include("admlogin.php");
            } elseif ($_GET['page'] === 'loginUser') {
              // Redirect to admlogin.php for loginUser page
              include("admlogin.php");
            } elseif ($_GET['page'] === 'obat') {
              // Include admobat.php for the 'obat' page
              include("admlogin.php");
            } else {
            ...
            include("admobat.php"); // Change "defaultContent.php" to the default content file you want to include
          }
          ?>
        </div><!-- /.container-fluid -->
      </div>
