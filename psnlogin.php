...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header("Location: mdpolipasien.php");
        } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=psnlogin">
                        <?php
                        if (isset($error)) {
                    ...
                    <div class="text-center">
                        <p class="mt-3">Belum punya akun? <a href="index.php?page=psnregister">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
