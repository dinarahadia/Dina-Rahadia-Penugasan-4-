                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jadwal" class="form-control" required>
                                    <?php
                                    // Mengambil dan menampilkan jadwal yang tersedia beserta nama dokter
                                    ...
                                    if ($resultJadwal && $resultJadwal->num_rows > 0) {
                                        while ($rowJadwal = $resultJadwal->fetch_assoc()) {
                                            echo '<option value="' . $rowJadwal['jadwal_id'] . '">' . $rowJadwal['nama_dokter'] . ' | ' . $rowJadwal['hari'] . ' (' . $rowJadwal['jam_mulai'] . ' - ' . $rowJadwal['jam_selesai'] . ')' . '</option>';
                                        }
                                    }
                                    ?>
                                </select>
