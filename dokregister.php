    ...
    if ($password === $confirm_password) {
        ...
        if ($result->num_rows == 0) {
            ...
            if (mysqli_query($mysqli, $insert_query)) {
                ...
                document.location='index.php?page=doklogin';
                </script>";
            } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=dokregister">
                        <?php
                        if (isset($error)) {
                    ...
                    <div class="text-center">
                        <p class="mt-3">Sudah Punya Akun? <a href="index.php?page=doklogin">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
